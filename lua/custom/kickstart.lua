...
local has_compiler = vim.fn.executable 'cc' == 1 or vim.fn.executable 'gcc' == 1 or vim.fn.executable 'clang' == 1 or vim.fn.executable 'zig' == 1
if vim.fn.executable 'tree-sitter' == 1 and has_compiler then
  require('nvim-treesitter').install(parsers)
else
  vim.notify('nvim-treesitter: tree-sitter CLI or C compiler missing, skipping parser install', vim.log.levels.WARN)
end
